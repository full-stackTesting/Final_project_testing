...
public class TC14_RegisterWhileCheckout extends TestBase {
	HomePage homeobj;
	RegisterPage regObj;
	CartPage cartObj;
...
//		Assert.assertTrue(checkoutObj.addressDetails.isDisplayed());
//		Assert.assertTrue(checkoutObj.reviewOrderTable.isDisplayed());
...
//		Assert.assertTrue(regObj.DeleteAccountBtn.isEnabled());
